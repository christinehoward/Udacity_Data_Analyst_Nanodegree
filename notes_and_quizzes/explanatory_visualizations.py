...
# Creating slide deck for presentation

# need to assign each cell to a particular type of slide element
# view > cell toolbar > slideshow
# markdown = slide type
# code cells:
    # doing things not important to presentation (loading packages, csv): skip
    # generating visualizations: sub-slide types, seen after parent slides

# go to anaconda terminal:
    # perform conversion
    # template for hiding coding portion on slides   